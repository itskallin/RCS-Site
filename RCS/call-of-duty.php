...
<head>
    <title>RandomCS | Call of Duty</title>
...
<div class="wrapper">
    ...
    <div class="interactive-slider-v2 img-cod">
        <div class="container">
    ...
    <div class="one-page">
            ...
            <div class="container content">
                <div class="row">
                <h2 class="title-v2">Xbox One | 2v2</h2>
                    <div class="col-md-6">
                        <div class="embed-responsive embed-responsive-16by9">
                <img class="img-responsive" src="assets/img/tournaments/black-ops.jpg" alt="Black Ops Xbox One">
                </div>

                    </div>
                    <div class="col-md-6">
                        
                        <p>Call of Duty is RCS's first game console tournament to host! Compete online to test your skills with a friend with another pair of challenging soldiers.</p>

                        <div class="row margin-bottom-10">
					<div class="col-md-6 md-margin-bottom-30">                
                        <h3 class="heading-sm">
                            <i class="icon-custom rounded-x icon-lg icon-bg-u fa fa-trophy"></i>
                            <span>1st Place: $5 </span>
                        </h3>
                    </div>
