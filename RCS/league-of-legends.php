...
<head>
    <title>RandomCS | Leauge of Legends</title>
...
<div class="wrapper">
    <?php include 'navbar.php';?><div class="interactive-slider-v2 img-gk">
        <div class="container">
    ...
    <div class="one-page">
            ...
            <div class="container content">
                <div class="row">
                <h2 class="title-v2">ARAM</h2>
                    <div class="col-md-6">
                        <div class="embed-responsive embed-responsive-16by9">
                <img class="img-responsive" src="assets/img/chibis/ARAM.png" alt="Lauren Spark ARAM tournament">
                </div>

                    </div>
                    <div class="col-md-6">
                        
                        <p>Take Part in our weekly ARAM tournament! Simple and clean, single elimination 32 team cap. </p>
                        <h3>Prizes</h3>
                        <p>  
                        <ul>
                        <li>1st Place:  1600 RP, Ryze, Triumphant Ryze, 4-Win IP Boost</li>
                        <li>2nd Place: 1200 RP, 4-Win IP Boost</li>
                        <li>3rd Place: 800 RP, 4-Win IP Boost</li>
                        <li>4th Place: 400 RP, 4-Win IP Boost</li>
                        <li>5th - 8th Place: 4-Win IP Boost</li>
                        </ul>
                        </p>
                        <br>
                ...
                <hr>
                <div class="row">
                <h2 class="title-v2">VODs</h2>
                    <div class="col-md-6">
                        <p> Tournament replays are available on the League of Legends VOD page. </p>

                    </div>
                    <div class="col-md-6">
                        
                        <div class="embed-responsive embed-responsive-16by9"> <a href="lol"><img class="img-responsive" src="assets/img/main/videocover.jpg" alt="Tournament Vods"></a>
                      </div>
