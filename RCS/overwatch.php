...
<head>
    <title>RandomCS | Overwatch</title>
...
<div class="wrapper">
    ...
    <div class="interactive-slider-v2 img-ow">
        <div class="container">
    ...
    <div class="one-page">
            ...
            <div class="container content">
                <div class="row">
                <h2 class="title-v2">Watchpoint</h2>
                    <div class="col-md-6">
                        <div class="embed-responsive embed-responsive-16by9">
                <img class="img-responsive" src="assets/img/tournaments/ow.png" alt="Watchpoint Overwatch">
                </div>
